            ...
            return (
                <>
                    <tr key={index} className='border'>
                        ...
                        <td>{((leaderData.Admissions / leaderData.Target) * 100).toFixed(2)}</td>
                        <td>{leaderData.TotalLead}</td>
                        <td>{((leaderData.Admissions / leaderData.TotalLead) * 100).toFixed(2)}</td>
                        <td>{leaderData.Admissions}</td>
                        <td>{(leaderData.CollectedRevenue/leaderData.Admissions).toFixed(2)}</td>
                        <td>{(leaderData.BilledRevenue/leaderData.Admissions).toFixed(2)}</td>
                        <td>{}</td>
                        <td>{}</td>
                        <td>{}</td>
